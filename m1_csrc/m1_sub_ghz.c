...
#define SUBGHZ_ISM_BANDS_LIST_NA			3   /* FCC Part 15 */
#define SUBGHZ_ISM_BANDS_LIST_EU			3   /* ETSI EN 300 220 */
#define SUBGHZ_ISM_BANDS_LIST_ASIA			2   /* ARIB / Japan MIC */
...
#define SUBGHZ_ISM_BAND_915_000					(float)915.00001
#define SUBGHZ_ISM_BAND_928_000_JP				(float)928.00001
...
{
	{SUBGHZ_ISM_BAND_300_000, SUBGHZ_ISM_BAND_348_000},    /* 300-348 MHz (Part 15.231) */
	{SUBGHZ_ISM_BAND_387_000, SUBGHZ_ISM_BAND_464_000},    /* 387-464 MHz (Part 15.231) */
	{SUBGHZ_ISM_BAND_902_000, SUBGHZ_ISM_BAND_928_000}     /* 902-928 MHz (Part 15.249 ISM) */
};

/* Europe — ETSI EN 300 220 / EN 302 208 */
static const float subghz_fcc_ism_bands_EU[SUBGHZ_ISM_BANDS_LIST_EU][2] =
{
	...
	{SUBGHZ_ISM_BAND_915_000, SUBGHZ_ISM_BAND_928_000}     /* 915-928 MHz (limited in some EU countries) */
};

/* Asia-Pacific — Japan ARIB STD-T67 / T108 */
static const float subghz_fcc_ism_bands_ASIA[SUBGHZ_ISM_BANDS_LIST_ASIA][2] =
{
	...
	{SUBGHZ_ISM_BAND_920_000, SUBGHZ_ISM_BAND_928_000_JP}  /* 920-928 MHz (Japan) */
};
